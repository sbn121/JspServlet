...
<body>
	...
	<!-- 
		...
		Java (Controller) : 눈에 안 보이지만 View에서 들어온 요청을 처리하는 부분.
	 ...
	 <!-- GET방식 -->
	 <h3>GET방식 요청</h3>
	 <form action="../Ex01_Request" method="get" autocomplete="off">
		<input type="text" name="id">
		<input type="text" name="pw">
	 	<input type="submit">
	 </form>
	 <form action="../Ex01_Request" method="post" autocomplete="off">
		<input type="text" name="id">
		<input type="text" name="pw">
	 	<input type="submit">
	 </form>
