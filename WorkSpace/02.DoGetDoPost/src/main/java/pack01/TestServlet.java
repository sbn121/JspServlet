...
public class TestServlet extends HttpServlet {
	...
	// URL : 톰캣 (localhost:portNumber(192.168.0.33:8080)/ Web Project / Mapping )
	//		 192.168.0.33:8080/do/te ↓GET방식 요청 시 doGetMethod가 자동으로 실행됨(TomCat)
	// 프로젝트를 새로 만들었을 때에는 TomCat이 프로젝트를 인식할 수 있게 add&remove를 통해서 프로젝트를 넣어준다.
